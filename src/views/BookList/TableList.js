...
function DataRow (props) {
    ...
    return (
        ...
        <CustomTableCell component="th" scope="row">
          {vehicleDetail.vehicleInfo.name}
        </CustomTableCell>
        <CustomTableCell numeric>{vehicleDetail.vehicleInfo.title}</CustomTableCell>
        {/* <CustomTableCell numeric>{vehicleDetail.vehicleInfo.department}</CustomTableCell> */}
        <CustomTableCell numeric>{vehicleDetail.vehicleInfo.bookingDate}</CustomTableCell>
        <CustomTableCell numeric>{vehicleDetail.vehicleInfo.startPlace}</CustomTableCell>
        <CustomTableCell numeric>{vehicleDetail.vehicleInfo.destination}</CustomTableCell>
        <CustomTableCell numeric>{vehicleDetail.vehicleInfo.timeout}</CustomTableCell>
      </TableRow>
    )
  }
